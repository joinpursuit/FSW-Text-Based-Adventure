...
function gameLoop() {
  ...
  sleep(2000);
  console.log(
    "lets's start, here are some instructions on how to play. first you will need fingers \n to click your mouse and clickity clack on your keyboard! Ignore any cancel options they are the same as picking option 2"
  );
  sleep(2000);
  console.log(
    " There is also a mini luck based game built in, so to get to the desired outcome you might first have to get luck! "
  );
  console.log(
    " to win you must find out if there is cake at the end of your journey!"
  );
  sleep(2000);
  ...
  if (choices[index] === "Earth") {
    ...
    if (choices1[index] === "Capture Humans") {
      sleep(2000);
      console.log(
        "you capture a tiny human and interrogate him about where all the cake is "
      );
      sleep(3000);
      console.log(
        " the human named " +
          nameInput +
          " sobs says he does not know where the cake is"
      );
      sleep(2000);
      console.log(
        " you hold a plasma laser up to the head of" + nameInput + " and say"
      );
      sleep(2000);
      console.log(
        " you must be the cake that I have been looking for maybe I will just eat you after I fatten you up"
      );
      sleep(2000);
      console.log(
        " you imprison the human several years pass as you feed him his own kind"
      );
      sleep(2000);
      console.log(
        nameInput + " cries out please no more I cannot eat any more"
      );
      sleep(2000);
      numberFeed = rls.question(
        "you force feed " +
          nameInput +
      ...
      if (numberFeed == 0) {
        console.log(
          "they cry out in praise and say thank you for not feeding me any more arms "
        );
        sleep(2000);
        ...
        sleep(2000);
        console.log(
          " you demand for the secret ingredient to make the ulimate cake"
        );
        sleep(2000);
        console.log(
          nameInput +
            " says: I will only tell you if you can beat me in a game of dice if you can roll a higher \n dice number then me I will make you the cake if you fail to You will have to go and make the cake your self ! "
        );
        sleep(2000);
        ...
        if (myDice > theirDice) {
          sleep(2000);
          console.log(
            "HAHA I WON NOW GIVE ME THE SECRET INGREDENT TO THE CAKE!"
          );
          sleep(2000);
          console.log(
            " YOU HAVE WON and now make cake for your entire race and are a HERO!"
          );
          sleep(2000);
          rls.keyInYN("do you really wanna play again?")
            ? gameLoop()
            : quitGame();
        } else {
          console.log(
            " you have lost the battle of the dice you must now work harder to find out how to get cake"
          );
          sleep(2000);
          console.log(
            "you torture the human regardless to find out the secrets of the cake only to find out the cake is a lie :( "
          );
          sleep(2000);
          rls.keyInYN(
            "oh common cant you just leave me alone ok do you wanna play this again little annoying human"
          )
            ? gameLoop()
            : quitGame();
          sleep(2000);
        ...
        sleep(2000);
        console.log(
          " I say: if you can say what ever phrase I say but backwards I will spare you and give \n u a chance at playing me at a game of dice to decide you fate!"
        );
        sleep(2000);
        ...
        if (myDice > theirDice) {
          ...
          sleep(2000);
          rls.keyInYN(
            "but the cake was a lie do you wanna play again to find the real cake \n cause real cakes dont have human flesh in them"
          )
            ? gameLoop()
            : quitGame();
        } else {
          sleep(2000);
          console.log(
            "oh no I Lost Darn you human I will let you live for now "
          );
          sleep(2000);
          //function for another mini game
          console.log(
            nameInput + " says: so am i free to go will you let me live"
          );
          sleep(2000);
          ...
          if (choices2[index] === "fight the human") {
            ...
            rls.keyInYN("you loose wanna play again?")
              ? gameLoop()
              : quitGame();
          } else if (choices2[index] === "eat the human") {
            sleep(2000);
            console.log(
              "there is no human left so no way to find out how to get cake !"
            );
            sleep(2000);
            rls.keyInYN("you loose wanna play again?")
              ? gameLoop()
            ...
            rls.keyInYN(
              "WOW THE CAKE WASENT A LIE CONGRATS U WIN WANNA Play again?"
            )
              ? gameLoop()
              : quitGame();
          }
      ...
      console.log(
        "you died because " +
          nameInput +
          " grabbed your gun and shot you in the groin ouch"
      );
      sleep(2000);
      rls.keyInYN("do you really wanna play again?") ? gameLoop() : quitGame();
      sleep(2000);
