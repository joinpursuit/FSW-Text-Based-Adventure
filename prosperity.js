...
const rulesInstructions =()=>{
        ...
        readline.keyInPause();
        console.log(chalk.greenBright("If by the end of day 4 you have $3000 dollars or more, You will recieve your share of the familie's wealth. And win the game."))
        console.log(chalk.greenBright('However, make $2999 or less and....well....lets say youll win the right to grind the 9-5 like all the other saps'))
        readline.keyInPause();
