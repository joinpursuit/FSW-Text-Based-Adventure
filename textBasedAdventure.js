...
const gameLoop = () => {
  console.log(
    `\nYou put on the V/R goggles and earbuds. Instantly, you are standing in the woods.\ou hear Maggie in your ear, "Hey ${name}, can you hear me ok?"\nYou nod slowly, in shocked at how real everything looks.`
  );
  readline.keyInPause();
  if (
