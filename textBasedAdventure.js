...
function startGame() {
  ...
  console.log(
    "You have been travelling for a long time and find yourself on a meadow near a forrest. Nearby you can see a small town. You can go to the forrest where you will have to fight monsters. If you win, you might find cold coins. Then you can go to town and spend it allll"
  );
  forrestOrTown();
}
...
function fightOrc() {
  ...
  if (playerHP > 0) {
    ...
    console.log("Sorry, the Orc knocked you out! \n You wake up several hours later, and discover that while you were out someone stole your gold...");
    playerGold = 0
    console.log(`You now have ${global.playerGold} gold coins`);
    forrestOrTown();
  }
...
function fightGoblin() {
  ...
  if (playerHP > 0) {
    ...
    console.log("Sorry, the Goblin knocked you out! \n You wake up several hours later, and discover that while you were out someone stole your gold...");
    playerGold = 0
    console.log(`You now have ${global.playerGold} gold coins`);
    forrestOrTown();
  }
...
function fightOgre() {
  console.log("Oh oh, you have encountered an Ogre");
  let playerHP = 15;
  ...
  if (playerHP > 1) {
    ...
    console.log("Sorry, the Ogre knocked you out! \n You wake up several hours later, and discover that while you were out someone stole your gold...");
    playerGold = 0
    console.log(`You now have ${global.playerGold} gold coins`);
    forrestOrTown();
  }
...
function chooseVisit() {
  (places = ["Church", "Tavern", "Market", "City Gates"]),
    (index = rls.keyInSelect(places, "You walk to the town to see what it has to offer. \n The local tavern has artisanal beer for Ξ5 or you could stay the night for only Ξ8. \n Nearby marketplace has a variety of shops to browse, e.g. an armory stocked with all sorts of swords for Ξ7 a piece or leather armor for Ξ4. \n You can also see the steeple of a a local church. \n Where would you like to go?"));
...
function visitChurch() {
  let answer = rls.keyInYN(
    `Welcome to our church. Would you like to make a donation? (You have ${global.playerGold} coins) \n`
  );
  if (answer) {
...
function visitTavern() {
  console.log(playerGold);
  let answer = rls.question(
    "Welcome to our tavern. Here you can spend a night or drink some artisanal beer. So, what would you like to do, sleep or drink? \n"
  );
  console.log(`You now have ${global.playerGold} gold coins`);
  if (answer === "sleep") {
...
function visitMarket() {
  let answer = rls.question(
    "Welcome to our armory. Here you can buy a sword or a leather armor. \n So, what would you like to buy, sword or armor? \n"
  );
  console.log(`You now have ${global.playerGold} gold coins`);
  if (answer === "sword") {
