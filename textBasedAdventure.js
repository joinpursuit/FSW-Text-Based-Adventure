...
//  let surgeon = ['Butcher', 'Retired Clown', 'Gardener', 'Award-Winning Surgeon']
//  for(let i = Math.floor(Math.random() * 5);
//     console.log(`The ${surgeon} will perform your surgery, and give you back the breath of life!`)
// }
