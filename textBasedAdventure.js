...
function play() {
  ...
  readySetGo = readline.question("Let's get started, shall we? Enter and we shall!")  
    ...
    let whichOne;
whichOne = readline.question("First, pick your favorite! What's it gonna be?! Sweet, smooth, and creamy MILK CHOCOLATE |or| rich, robust, and decadent DARK CHOCOLATE? Enter milk or dark!");
if (whichOne === "milk"){
