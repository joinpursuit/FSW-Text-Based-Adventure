...
const trollUnderBridge = () => {
    ...
    if (figure === "runners") {
        ...
        if(keepfighting === "fight") {
            ...
            let whatsNext = readline.question("The figure somehow managaes to get you in a head lock, you can continue the tussle or surrender (continue || surrender)? ") 
            if (whatsNext === "continue") {
                console.log("The figure uses so wizarding world of Harry Potter magic on you causing your body to go numb, sorry you're out. This is thend for you")
                startOver();
...
const startOver = () => {
    ...
    console.log(`Sorry  your run has come to an end. This is your final score  \n Thanks for playing and rememebr to stop and help those around you!!!`)
