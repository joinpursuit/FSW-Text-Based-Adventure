...
console.log(
  "Traffic looks crazy today. And your train is also having delays. Do you: "
);
...
transportationComplete: while (transportationComplete === false) {
  switch (transportation) {
    case "1":
      ...
      console.log(
        "The reckless driver didn't like this, and when a red light was reached he exited his car."
      );
    ...
    case "2":
      ...
      console.log(
        "You notice an entirely empty bench, except for a lone slice of pizza, and take a seat."
      );
      console.log(
        "After a few minutes of sitting you feel a brush against your leg."
      );
      console.log(
      ...
      ratComplete: while (ratComplete === false) {
        switch (ratCounter) {
          case "1":
            ...
            console.log(
              "Mid swing the rat jumps and latches onto your leg with it's claws."
            );
            console.log(
          ...
          case "2":
            ...
            console.log(
              "You grab the rat by it's tail and throw it at the incoming train."
            );
            console.log(
          ...
          case "3":
            console.log(
              "After the rat lands you immediately sprint to the other side of the platform."
            );
            console.log(
          ...
          case "4":
            console.log(
              "You grab the slice of pizza and throw it next to the rat."
            );
            console.log(
              "The rat looks at you, then the pizza, then back at you."
            );
            console.log("It stands on it's hind legs, and bows.");
            console.log(
              "Four turtles emerge from under the bench and help the rat carry the slice away."
            );
            console.log(
      ...
      console.log(
        "Your train arrives and you continue on your adventure to work."
      );
      break transportationComplete;
    default:
      console.log("I do not understand.");
...
console.log(
  "After what seems like forever you finally arrive outside of your office building"
);
console.log("You step inside the building.");
console.log(
  "The security guard makes eye contact with you and you smile back."
);
